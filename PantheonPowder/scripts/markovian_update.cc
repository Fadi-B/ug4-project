...
/*IMPORTANT: THIS FILE BELONGS TO THE COPA AUTHORS! However, there was a bug in it and for Copa to work I have to patch it manually.
 *           I am using their file but editing the relevant parts that were not working. 
 */
using namespace std;
